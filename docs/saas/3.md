...
1. **Download** and **install** the latest Java SDKs (JDK 24 is recommended) using the vendor link below.
    ...
    - It is stronlgy recommended that you **install JDK 21** (or as early as JDK 11).
    - Newer-generation MacOS users will probably want to select the *ARM64 DMG Installer* edition.
