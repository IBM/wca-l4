...
6. Select (tick) the **I accept the product Terms and Conditions of this registration form**^[A]^ button under the *Account Notice* header, then click **Join account**^[B]^ to continue.
...
19. **Check**^[A]^ (tick) the box to the left of the *Select your license preference for response generations* option to mark the task as complete.
